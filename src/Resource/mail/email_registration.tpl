...
<br/>
<p> Username: <span style="color:#003e86;">{$mail_username}</span></p>
<p> Password: <span style="color:#003e86;">{$mail_username} <a href="{speed link="index.php?option=members&view=resetpass"}">forgot?</a></span></p>
<p>You can manage your account online by visiting {$sitename}.</p>
<p>We suggest that you save this email for further reference.</p>
<p>You can use it to Sign in to your account on {$sitename}</p>
<p>-----------------------<p>
