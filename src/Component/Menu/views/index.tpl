...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td align="left"><h4>Menu (<span class="ac-ajax-total">{$rows.total}</span>)</h4></td>
        <td align="right" width="50%">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <a href="{speed link="menu/add"}" title="Add New" class="qtipbox btn btn-info" role="button"><i class="fa fa-plus"></i> New</a>
                </span>
            </div>
        </td>
    </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ui-data-table table table-bordered">
    ...
    <tbody  class="ac-ajax-content">
        ...
        <tr id="number{$row.id}">
            ...
            <td>{$row.menu_type}</td>
            <td align="center">
                <a href="{speed link="index.php?option=menu&view=add&id={$row.id}"}" title="Edit" class="qtipbox">
