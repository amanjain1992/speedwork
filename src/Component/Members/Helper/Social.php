...
class Social extends Helper
{
    ...
    public function connect()
    {
        ...
        try {
            $this->hybrid = new Hybridauth($this->config['config']);

            if (!$this->hybrid->isConnectedWith($this->network)) {
            ...
            $adapter       = $this->hybrid->authenticate($this->network);
    ...
    public function linkAccount($userid)
    {
        ...
        $save['session_info'] = $this->hybrid->getStorageData();
    ...
    {
        $session_info = $this->hybrid->getStorageData();
        if ($session_info) {
