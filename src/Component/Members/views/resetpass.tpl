<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="header">Forgot password? Get in your inbox</h3>
    </div>
    <div class="panel-body">
        <form role="easySubmit" action="{speed link='index.php?option=members&view=resetpass'}" method="post">
        ...
        <div class="text-center signup-now">
            <a href="{speed link='members/login'}" class="forgot">Back to login</a>
        </div>
    </div>
</div>
